...
import { Badge } from '@/shared/ui-shad-cn/ui/badge'
import { Command, CommandGroup, CommandItem, CommandList } from '@/shared/ui-shad-cn/ui/command'
...
function isOptionsExist(groupOption: GroupOption, targetOption: Option[]) {
  for (const [_, value] of Object.entries(groupOption)) {
