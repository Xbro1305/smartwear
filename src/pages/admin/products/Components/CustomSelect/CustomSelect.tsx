...
export const CustomSelect: React.FC<SelectProps> = ({ data, onChange, value, placeholder }) => {
  const [opened, setOpened] = useState(false)
  return (
    <div className="relative">
      <label className="w-[370px] cursor-pointer px-[15px] h-[40px] border-[1px] flex items-center justify-between border-solid border-[#BDBFC7] rounded-xl">
        <p
